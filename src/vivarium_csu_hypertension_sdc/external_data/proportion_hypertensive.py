...
HYPERTENSION_DATA_FOLDER = Path(ARTIFACT_FOLDER / f'vivarium_csu_hypertension_sdc/proportion_hypertensive/')
...
def prep_input_data(loc_dir, location):
    ...
    for measure in ['exposure', 'exposure_standard_deviation', 'exposure_distribution_weights']:
        key = f'risk_factor.high_systolic_blood_pressure.{measure}'
        _worker(key, art_loc, [], data_art)
...
def main():
    ...
    out_dir = HYPERTENSION_DATA_FOLDER
