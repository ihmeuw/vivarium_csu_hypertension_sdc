...
class TreatmentAlgorithm:
    ...
    def setup(self, builder):
        ...
        utilization_data = builder.data.load('healthcare_entity.outpatient_visits.utilization_rate')
        self.utilization_data = builder.lookup.build_table(utilization_data,
                                                           key_columns=['sex'],
